                    ...
                    <div className="row g-5 align-items-center">
                        ...
                        <div className="col-lg-6 col-md-12 col-sm-12 col-12 order-lg-1 order-md-2 order-sm-2 order-2 mt_md--50 mt_sm--50">
                            ...
                            <div className="mobile-padding">
                                ...
                                <div className="rts-title-area">
                                    ...
                                    <h2 className="title">
                                        Desarrollamos Tecnología Estratégica para Empresas que Escalan
                                    </h2>
                                </div>
                                ...
                                <div className="about-inner">
                                    <p className="disc">
                                        ...
                                        grandes que buscan evolucionar con tecnología sólida, segura y preparada para el crecimiento. <br /><br />

                                        Combinamos desarrollo a medida, arquitectura moderna, experiencia UX/UI estratégica y visión de negocio 
                                        para construir plataformas robustas que optimizan procesos, aumentan eficiencia y generan ventaja competitiva. <br /><br />

                                        No construimos sitios web.
                                        Construimos infraestructura digital preparada para escalar. <br /><br />
                                        ...
                                        <div className="col-lg-6 col-md-6 col-sm-6 col-12">
                                            <div className="author-inner">
                                                <a className="thumbnail" href="#">
                                                    <img src="assets/images/about/avatar321.png" alt="finbiz_founder" />
                                                </a>
                        ...
                        <div className="col-lg-6 col-md-12 col-sm-12 col-12 order-lg-2 order-md-1 order-sm-1 order-1">
                            <div className="about-one-thumbnail">
                                <img src="assets/images/about/main/foto77.png" alt="about-finbiz" />
                                <img className="small-img" src="assets/images/about/main/devOps44.png" alt="finbiz-small" />
