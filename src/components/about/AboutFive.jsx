...
function AboutFive() {
    return (
        <div>
            <div
                className="rts-about-area-start rts-section-gapBottom"
                id="about"
                ...
                <div className="container">
                    <div className="row align-items-center" style={{ paddingTop: 100 }}>
                        ...
                        <div className="col-lg-6 pr--70 pr_md--0 pr_sm--0">
                            ...
                            {/* 🔥 WRAPPER MOBILE */}
                            <div className="about5-mobile-padding">
                                ...
                                <div className="title-area-style-six text-start">
                                    <div className="pre-title">
                                        ...
                                        <img className="two" src="assets/images/banner/shape/pre-title.png" alt="pre-title" />
                                    </div>
                        ...
                        <div className="col-lg-6">
                            <div className="thumbnail-about-six">
                                <img src="assets/images/about/service443.png" alt="about-image" />
                            </div>
                        </div>
